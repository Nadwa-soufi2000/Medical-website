...
export default function NewService()
{
    ...
    function AddService()
    {
         nav('/providerDashboard/services')
    }
    return(
        <form  onSubmit={AddService} className="parent-services">
            <div className="sr1">
                <div className="sr1-ch">
                    ...
                    <div className="checkbox-group">
                        ...
                        <div className="dentist">
                            <input id="ray" type="checkbox" value={'Medical x ra'} onChange={(e) => setxRay(e.target.value)}/>
